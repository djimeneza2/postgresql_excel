...
ruta='P:/EnerSur/Comercial/Publico/z_escrit_Daniel/server_mercados/desarrollo_BD_peru/simple_peru_dev/Data/maintenance/'
...
for column in dataframe_frame_2.columns:
    ...
    if column in ['YEAR','MONTH','DAY','PERIOD','DATE']: 
        ...
        x=np.array(dataframe_frame_2['DATE'][dataframe_frame_2['DATE']<datetime.datetime(2024,8,1)])
        y=np.array(dataframe_frame_2[column][dataframe_frame_2['DATE']<datetime.datetime(2024,8,1)])
        fig, ax =plt.subplots()
