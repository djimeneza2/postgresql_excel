...
df_data_constraints=pkg_copy_paste.pd.read_csv('./Vol_Min_Hydro.csv')
...
Min_vol_Edegel Lag
Min_vol_Junin Lago
Min_vol_LagunasEP Em
'''

embalse_prueba='Min_vol_LagunasEP Em'
...
plantilla_embalses.to_csv('./data_Min_vol_LagunasEP_Em.csv',index=False)
