...
if __name__=='__main__':
    ...
    data_copy_paste=pkg_copy_paste.pd.read_excel('factura_python.xlsx',sheet_name='FTE_PY',encoding='latin-1')
    ...
    array_copy_final_execute=pkg_copy_paste.np.array(data_copy_paste['execute'])
